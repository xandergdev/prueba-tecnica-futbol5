...
public class EntrenamientoController {
    ...
    @PostMapping
    public ResponseEntity<Entrenamiento> registrar(@RequestBody EntrenamientoRequestDTO dto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(entrenamientoService.registroEntrenamiento(dto));
    }
